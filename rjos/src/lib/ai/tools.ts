...
// Claude tool definitions with manually written JSON schemas
// (zod-to-json-schema is incompatible with zod v4)

export const TOOLS: Record<string, Anthropic.Tool> = {
  generateGraph: {
